...
/**
 * @author lzx
 * @date 2023/08/29 10:41
 *  德鲁伊 链接phoenix的连接池
 **/
public class DruidPhoenixUtil {
    ...
    public static DruidDataSource getDruidDataSource() {
        ...
        // 设置驱动全类名
        druidDataSource.setDriverClassName(CommonConfig.PHOENIX_DRIVER);
        // 设置连接 url
        druidDataSource.setUrl(CommonConfig.PHOENIX_SERVER);
        // 设置初始化连接池时池中连接的数量
